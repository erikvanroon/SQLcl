...
var registration = (function () {
  ...
  function unregisterCommand (cmdName) {
    ...
    if (commandFound) {
        feedback ("Command has been UNRegistered: " + RegUnregCommandName , RegUnregMsgLevelInfo);
    } else {
        feedback ("Command was not found, hence could not be UNRegistered: " + RegUnregCommandName , RegUnregMsgLevelInfo);
    }
  ...
  function registerCommand (cmdName, functionToExecute, beginEvent, endEvent) {
      ...
      feedback ("Trying to unregister command in case it has been registered before: " + RegUnregCommandName , RegUnregMsgLevelInfo);
      unregisterCommand (RegUnregCommandName);

      // Register the custom command
      jRegUnregCommandRegistry.addForAllStmtsListener(customCommandToRegister.class);

      feedback ("Command has been registered: " + RegUnregCommandName , RegUnregMsgLevelImportant);
